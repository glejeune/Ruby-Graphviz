...
* ruby2gv, a simple tool that's allow you to create a dependency graph from a ruby script :

  ruby2gv -Tpng -ogem.png /usr/bin/gem

* gem2gv, a tools that's allow you to create a dependency graph between gems :

	gem2gv ruby-graphviz
