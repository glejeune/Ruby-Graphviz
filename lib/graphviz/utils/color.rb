...
class Color 
   ...
   class <<self
      def rgb(r, g, b, a = nil)
         ...
         color.color = COLORS.index(color.rgba_string)
      ...
      def color(c)
         ...
         unless rgb.nil?
            ...
            color.h, color.s, color.v = rgb_to_hsv(color.r, color.g, color.b)
         end
...
# p Color.color("brown")
# p Color.hsv(0.0, 0.745454545454545, 0.647058823529412)
# p Color.rgb("a5", "2a", "2a")
